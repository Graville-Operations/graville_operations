...
class MaterialService {
  ...
  static Future<MaterialModel> createMaterial(MaterialModel material) async {
    final url = Uri.parse('$_baseUrl/');

    final response = await http.post(
      url,
      headers: _headers,
      body: jsonEncode(material.toCreateJson()),
    );
  ...
  static Future<MaterialModel> updateMaterial(
      int id, MaterialModel material) async {
