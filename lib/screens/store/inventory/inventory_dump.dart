...
import 'package:graville_operations/screens/store/inventory_details_screen.dart';
import 'package:graville_operations/screens/store/list_of_materials.dart';
...
class _InventoryScreenState extends State<InventoryScreen> {
  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      setState(() { _errorMessage = 'Failed to load store. Please try again.'; _isLoading = false; });
    }
  }
          ...
          _isLoading
            ...
            if (_filteredInventory.isEmpty)
              const Padding(padding: EdgeInsets.all(16),
                  child: Text('No store records found.',
