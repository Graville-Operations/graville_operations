                  ...
                  [
                    ...
                    SectionCard(
                      child: Column(
                        ...
                        children: [
                          _label(
                              Icons.business_center_outlined, 'Tender Details'),
                          const SizedBox(height: 12),
                          CustomDropdown<String>(
                            value:
                                controller.state.selectedCompany.value.isEmpty
                                    ? null
                            ...
                            onChanged: (company) =>
                                controller.companyChange(company),
                          ),
                          const SizedBox(height: 10),
                          CustomTextInput(
                            controller:
                                controller.state.inquiringEntityController,
                            hintText:
                                'Inquiring entity (org. that issued the tender)',
                          ...
                          GestureDetector(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                border: Border.all(
                                  color:
                                      controller.state.completionDate.value !=
                                              null
                                          ? Colors.black
